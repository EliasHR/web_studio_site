...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><section class="top" data-v-9f47f244><div class="container" data-v-9f47f244><div class="top__wrapper" data-v-9f47f244><div class="top__info" data-v-9f47f244><div class="top__info-text" data-v-9f47f244><h1 class="top__title" data-v-9f47f244> Разработка<br data-v-9f47f244><span class="top__title_gradient" data-v-9f47f244>ботов</span> и <span class="top__title_gradient" data-v-9f47f244>сайтов</span><br data-v-9f47f244> с гарантией результата </h1><div class="top__text" data-v-9f47f244> Создаем, внедряем, тестируем, поддерживаем it-продукты </div></div><div class="top__actions" data-v-9f47f244>`);
  ...
  _push(`<a class="top__link" href="https://t.me/code_mode7" target="_blank" data-v-9f47f244>`);
  ...
  _push(`</a></div></div><picture data-v-9f47f244><source${ssrRenderAttr("srcset", _imports_0)} media="(max-width: 767.99px)" width="282px" height="182px" data-v-9f47f244><source${ssrRenderAttr("srcset", _imports_1)} media="(max-width: 1199.99px)" width="297px" height="249px" data-v-9f47f244><img class="top__illustration"${ssrRenderAttr("src", _imports_2)} alt="Декоративный элемент главного блока страницы - треугольные скобки с косой чертой внутри" width="500px" height="350px" data-v-9f47f244></picture></div><div class="top__bottom-section" data-v-9f47f244><div class="top__gift" data-v-9f47f244>`);
  _push(ssrRenderComponent(_component_gift_comp, null, null, _parent));
  _push(`</div><div class="top__services" data-v-9f47f244><ul class="top__services-list" data-v-9f47f244><li class="top__services-item" data-v-9f47f244>Телеграм бот</li><li class="top__services-item" data-v-9f47f244>Интеграции с CRM, 1С, МойСклад</li><li class="top__services-item top__services-item_gradient" data-v-9f47f244> Решения для бизнеса </li><li class="top__services-item" data-v-9f47f244>Интеграции с CRM, 1С, МойСклад</li><li class="top__services-item" data-v-9f47f244>Создание сайта</li><li class="top__services-item" data-v-9f47f244>Доработка, перенос, редизайн</li></ul></div></div></div></section>`);
  if ($data.showDialog) {
...
const TopComp = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-9f47f244"]]);
const _sfc_main = {
  __name: "HomeView",
  __ssrInlineRender: true,
  setup(__props) {
    const ServicesComp = defineAsyncComponent(() => import("./ServicesComp-155I-hWm.js"));
    const PromoComp = defineAsyncComponent(() => import("./PromoComp-CW8EGpWT.js"));
    const ProjectsComp = defineAsyncComponent(() => import("./ProjectsComp-hXLDCcgC.js"));
    ...
    const ReviewsComp = defineAsyncComponent(() => import("./ReviewsComp-BrGyfdh9.js"));
    const AboutComp = defineAsyncComponent(() => import("./AboutComp-DsTs5P-B.js"));
    const TechnologiesComp = defineAsyncComponent(() => import("./TechnologiesComp-xOros9Oy.js"));
    const FaqComp = defineAsyncComponent(() => import("./FaqComp-DbF23KWr.js"));
    const ContactsComp = defineAsyncComponent(() => import("./ContactsComp-BNK8yQ0x.js"));
