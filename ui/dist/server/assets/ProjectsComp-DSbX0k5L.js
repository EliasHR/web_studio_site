...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><section class="projects" id="examples" data-v-849d3720><div class="container" data-v-849d3720>`);
  ...
  if (!$setup.projectsStore.projectsIsLoading) {
    _push(`<div class="projects__wrapper" data-v-849d3720>`);
    if ($setup.projectsStore.projects.length > 0) {
      _push(`<div class="projects__item" data-v-849d3720><div class="projects__item-bg" style="${ssrRenderStyle({
        backgroundImage: `url(${$options.getCoverImage($setup.projectsStore.projects[0])})`
      })}" data-v-849d3720><h3 class="${ssrRenderClass([{
        "projects__item-title_white": $setup.projectsStore.projects[0].title_alt_color
      }, "projects__item-title"])}" data-v-849d3720>${ssrInterpolate(this.projectsStore.projects[0].title)}</h3></div></div>`);
    } else {
      _push(`<!---->`);
    }
    _push(`<!--[-->`);
    ssrRenderList(this.projectsStore.projects.slice(1), (project, index) => {
      _push(`<div class="projects__item" data-v-849d3720><div class="projects__item-bg" style="${ssrRenderStyle({ backgroundImage: `url(${$options.getCoverImage(project)})` })}" data-v-849d3720><h3 class="${ssrRenderClass([{ "projects__item-title_white": project.title_alt_color }, "projects__item-title"])}" data-v-849d3720>${ssrInterpolate(project.title)}</h3></div></div>`);
    });
    _push(`<!--]--><div class="projects__item" data-v-849d3720><div class="projects__item-bg projects__request" data-v-849d3720><h3 class="projects__item-title projects__item-title_white" data-v-849d3720> Какая задача у вас? </h3><img class="projects__request-gear"${ssrRenderAttr("src", _imports_0)} alt="Шестерёнка" width="213px" height="236px" data-v-849d3720><button class="projects__request-button projects__link projects__item-title_white" data-v-849d3720> Оставить заявку </button></div></div></div>`);
  } else {
    _push(ssrRenderComponent(_component_loading_comp, null, null, _parent));
  }
  _push(`</div></section>`);
...
const ProjectsComp = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-849d3720"]]);
export {
