...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$setup.reviewsStore.reviewsIsLoading) {
    ...
    _push(`<picture class="swiper-slide__image"><source media="(max-width: 399.99px)"${ssrRenderAttr("srcset", _imports_0)}><source media="(max-width: 991.99px)"${ssrRenderAttr("srcset", _imports_1)}><source media="(max-width: 1199.99px)"${ssrRenderAttr("srcset", _imports_2)}><img loading="lazy"${ssrRenderAttr("src", _imports_3)} alt="Большая кавычка" class="reviews__image"></picture></div>`);
  } else {
