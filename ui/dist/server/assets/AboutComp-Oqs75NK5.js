import { _ as _export_sfc, e as PBase, H as H2Custom, P as PSuperSmall } from "../entry-server.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "about",
    id: "about"
  }, _attrs))} data-v-55cd3579><div class="container" data-v-55cd3579><div class="about__content" data-v-55cd3579>`);
  ...
  _push(`<div class="about__wrapper" data-v-55cd3579><div class="about__text-wrapper" data-v-55cd3579><div class="about__text_offset" data-v-55cd3579>`);
  ...
  _push(ssrRenderComponent(_component_p_middle, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<b data-v-55cd3579${_scopeId}>– Создать чат-бот телеграм.</b>`);
      } else {
        return [
  ...
  _push(`</div><div class="about__text_highlighted" data-v-55cd3579>`);
  ...
  _push(ssrRenderComponent(_component_p_middle, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<b data-v-55cd3579${_scopeId}>– Оптимизировать бизнес-процессы.</b>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_p_middle, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<b data-v-55cd3579${_scopeId}>– Доработать или «переделать» текущий сайт.</b>`);
      } else {
        return [
  ...
  _push(`<div class="about__text_offset" data-v-55cd3579>`);
  _push(ssrRenderComponent(_component_p_middle, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
  ...
  _push(`</div></div><div class="about__swiper" data-v-55cd3579><picture data-v-55cd3579><source${ssrRenderAttr("srcset", _imports_0)} media="(max-width: 399.99px)" data-v-55cd3579><source${ssrRenderAttr("srcset", _imports_1)} media="(max-width: 991.99px)" data-v-55cd3579><source${ssrRenderAttr("srcset", _imports_2)} media="(max-width: 1199.99px)" data-v-55cd3579><img class="about__image"${ssrRenderAttr("src", _imports_3)} alt="Декоративый элемент страницы &#39;О нас&#39;" width="568px" height="817px" loading="lazy" data-v-55cd3579></picture></div></div></div></div></section>`);
}
...
const AboutComp = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-55cd3579"]]);
export {
