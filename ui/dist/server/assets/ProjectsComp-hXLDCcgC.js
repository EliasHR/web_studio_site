import { _ as _export_sfc, I as IconClose, H as HamburgerTelegram, b as HamburgerWhatsapp, N as NavItem, B as ButtonMiddle, P as PSuperSmall, D as DialogForm } from "../entry-server.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><section class="projects" id="examples" data-v-d52b2027><div class="container" data-v-d52b2027>`);
  ...
  if (!$setup.projectsStore.projectsIsLoading) {
    _push(`<div class="projects__wrapper" data-v-d52b2027>`);
    if ($setup.projectsStore.projects.length > 0) {
      _push(`<div class="projects__item" data-v-d52b2027><div class="projects__item-bg" style="${ssrRenderStyle({
        backgroundImage: `url(${$options.getCoverImage($setup.projectsStore.projects[0])})`
      })}" data-v-d52b2027><h3 class="${ssrRenderClass([{
        "projects__item-title_white": $setup.projectsStore.projects[0].title_alt_color
      }, "projects__item-title"])}" data-v-d52b2027>${ssrInterpolate(this.projectsStore.projects[0].title)}</h3></div></div>`);
    } else {
      _push(`<!---->`);
    }
    _push(`<!--[-->`);
    ssrRenderList(this.projectsStore.projects.slice(1), (project, index) => {
      _push(`<div class="projects__item" data-v-d52b2027><div class="projects__item-bg" style="${ssrRenderStyle({ backgroundImage: `url(${$options.getCoverImage(project)})` })}" data-v-d52b2027><h3 class="${ssrRenderClass([{ "projects__item-title_white": project.title_alt_color }, "projects__item-title"])}" data-v-d52b2027>${ssrInterpolate(project.title)}</h3></div></div>`);
    });
    _push(`<!--]--><div class="projects__item" data-v-d52b2027><div class="projects__item-bg projects__request" data-v-d52b2027><h3 class="projects__item-title projects__item-title_white" data-v-d52b2027> Какая задача у вас? </h3><img class="projects__request-gear"${ssrRenderAttr("src", _imports_0)} alt="Шестерёнка" width="213px" height="236px" data-v-d52b2027><button class="projects__request-button projects__link projects__item-title_white" data-v-d52b2027> Оставить заявку </button></div></div></div>`);
  } else {
    _push(ssrRenderComponent(_component_loading_comp, null, null, _parent));
  }
  _push(`</div></section>`);
...
const ProjectsComp = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d52b2027"]]);
export {
